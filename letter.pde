...
float[][] XL = {
     {60.0,40.0,80.0,20.0,50.0,20.0},   /* a */
     ...
     {60.0,40.0,80.0,20.0,50.0,20.0}    /* æ */
      };
...
float[][] YL = {
     ...
     {60.0,60.0,20.0,20.0,20.0,60.0}     /* æ */
      };
...
void keyPressed(){
  ...
  if ((key >= 'a') && (key <= 'æ')){
    ...
    // our goal is for currKey to be 0..27, NOT A..Æ
    tmpKey = tmpKey - 'A';
